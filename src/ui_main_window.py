...
class UiMainWindow:
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "MIDI Monitor"))
        self.btn_send_out.setText(_translate("MainWindow", "Send"))
        self.btn_clear_out.setText(_translate("MainWindow", "Clear"))
        self.btn_stop_out.setText(_translate("MainWindow", "Stop"))
        self.btn_clear_in.setText(_translate("MainWindow", "Clear"))
        self.syslog_label.setText(_translate("MainWindow", "Syslog"))
